...
<div id="container"> <!-- LA PAGE EST CLEAN -->
    <div class="card">
        ...
        <div aria-label="votre nom" class="profil_name">Nom : {{user.username}}</div>
        <div aria-label="votre mail" class="profil_mail">Mail : {{user.email}}</div>
        <div aria-label="votre type de profil" class="profil_type" v-if="user.isAdmin == 1">Profile : Administrateur</div>
        <div aria-label="votre type de profil" class="profil_type" v-else>Profile : Utilisateur</div>
