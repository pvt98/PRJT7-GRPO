  ...
  <div class="card">
        ...
        <div class="command-cont-all">
            <div v-for="comment in comments" :key="comment.id" class="comment">
                <div aria-label="date du commentaire" class="date_comment"> {{ formatDate(comment.createdAt) }} </div>
                <div aria-label="nom de la personne qui a posté le commentaire" class="name_comment">{{ comment.User.username }}</div>
                <div aria-label="contenu du commentaire" class="content_comment">{{ comment.content }}</div>
                <i v-if="user.isAdmin == 1 || user.id == comment.userId" @click="deleteComment(comment.id)" aria-label="supprimer le commentaire" class="fas fa-trash" id="icon"></i>
            </div>
